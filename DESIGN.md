...
2.  **Strict Range:** The bitmask logic allows invalid inputs (e.g., 3 or 7). While the contract defaults these to a loss, enforcing `input \in {1, 2, 4}` would improve DX.
